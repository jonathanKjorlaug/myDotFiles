    ...
    export namespace Shumate {
        ...
        class DataSourceRequest extends GObject.Object {
            ...
            emit<K extends keyof DataSourceRequest.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<DataSourceRequest.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
            ...
            implements Gio.ListModel<A>
        {
            ...
            emit<K extends keyof MapSourceRegistry.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<MapSourceRegistry.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class VectorReaderIter extends GObject.Object {
            ...
            emit<K extends keyof VectorReaderIter.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<VectorReaderIter.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class VectorSpriteSheet extends GObject.Object {
            ...
            emit<K extends keyof VectorSpriteSheet.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<VectorSpriteSheet.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
