...
declare module 'gi://FolksEds?version=0.7' {
    ...
    import type Folks from 'gi://Folks?version=0.7';
    ...
    export namespace FolksEds {
        ...
        class PersonaStore extends Folks.PersonaStore {
            ...
            static remove_address_book(
                store: PersonaStore,
                _callback_?: Gio.AsyncReadyCallback<PersonaStore> | null,
            ): void;
