/// <reference path="./rygelrenderer-2.8.d.ts" />
...
declare module 'gi://RygelRendererGst?version=2.8' {
    // Module dependencies
    import type RygelRenderer from 'gi://RygelRenderer?version=2.8';
    ...
    export namespace RygelRendererGst {
        ...
        namespace PlaybinPlayer {
            ...
            interface ConstructorProps
                extends GObject.Object.ConstructorProps,
                    RygelRenderer.MediaPlayer.ConstructorProps {
                playbin: Gst.Element;
        ...
        class PlaybinRenderer extends RygelRenderer.MediaRenderer {
            ...
            emit<K extends keyof PlaybinRenderer.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<PlaybinRenderer.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
