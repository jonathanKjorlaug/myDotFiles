    ...
    export namespace RygelCore {
        ...
        class ConnectionManager extends GUPnP.Service {
            ...
            emit<K extends keyof ConnectionManager.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<ConnectionManager.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
        ...
        class BasicManagement extends GUPnP.Service {
            ...
            emit<K extends keyof BasicManagement.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<BasicManagement.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class DescriptionFile extends GObject.Object {
            ...
            emit<K extends keyof DescriptionFile.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<DescriptionFile.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class EnergyManagement extends GUPnP.Service {
            ...
            emit<K extends keyof EnergyManagement.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<EnergyManagement.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class RootDeviceFactory extends GObject.Object implements Gio.Initable {
            ...
            emit<K extends keyof RootDeviceFactory.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<RootDeviceFactory.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class BaseConfiguration extends GObject.Object implements Configuration {
            ...
            emit<K extends keyof BaseConfiguration.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<BaseConfiguration.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class EnvironmentConfig extends GObject.Object implements Configuration {
            ...
            emit<K extends keyof EnvironmentConfig.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<EnvironmentConfig.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class XMLUtilsIterator {
            ...
            emit<K extends keyof XMLUtilsIterator.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<XMLUtilsIterator.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class PluginInformation extends GObject.Object {
            ...
            emit<K extends keyof PluginInformation.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<PluginInformation.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class Dlna150Hacks extends GObject.Object {
             ...
             * @internal
             */
            $signals: Dlna150Hacks.SignalSignatures;
            ...
            constructor(properties?: Partial<Dlna150Hacks.ConstructorProps>, ...args: any[]);
