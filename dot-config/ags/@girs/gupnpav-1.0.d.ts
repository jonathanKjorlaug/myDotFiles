    ...
    export namespace GUPnPAV {
        ...
        class DIDLLiteContainer extends DIDLLiteObject {
            ...
            emit<K extends keyof DIDLLiteContainer.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<DIDLLiteContainer.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class DIDLLiteDescriptor extends GObject.Object {
            ...
            emit<K extends keyof DIDLLiteDescriptor.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<DIDLLiteDescriptor.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class DIDLLiteResource extends GObject.Object {
            ...
            emit<K extends keyof DIDLLiteResource.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<DIDLLiteResource.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class FeatureListParser extends GObject.Object {
            ...
            emit<K extends keyof FeatureListParser.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<FeatureListParser.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class LastChangeParser extends GObject.Object {
            ...
            emit<K extends keyof LastChangeParser.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<LastChangeParser.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class MediaCollection extends GObject.Object {
            ...
            emit<K extends keyof MediaCollection.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<MediaCollection.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
