    ...
    export namespace EDataServerUI {
        ...
        class CellRendererColor extends Gtk.CellRenderer {
            ...
            emit<K extends keyof CellRendererColor.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<CellRendererColor.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
        ...
        class CredentialsPrompterImplOAuth2 extends CredentialsPrompterImpl {
            ...
            emit<K extends keyof CredentialsPrompterImplOAuth2.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<CredentialsPrompterImplOAuth2.SignalSignatures[K]> extends [
                    any,
                    ...infer Q,
                ]
                    ? Q
            ...
            implements Atk.ImplementorIface, EDataServer.Extensible, Gtk.Buildable, Gtk.Orientable
        {
            ...
            emit<K extends keyof RemindersWidget.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<RemindersWidget.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
